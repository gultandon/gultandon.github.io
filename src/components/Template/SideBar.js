...
const SideBar = () => (
  <section id="sidebar">
    <section id="intro">
      ...
      <header>
        <h2>Gul Tandon</h2>
        <p><a id="lowermail" href="mailto:gultandon@gmail.com">gultandon@gmail.com</a></p>
      </header>
    </section>

    <section className="blurb">
      <h2>About</h2>
      <p>Hi, I&apos;m Gul. I am a <a href="https://icme.stanford.edu/">Stanford ICME</a> graduate, YC Alumni,
